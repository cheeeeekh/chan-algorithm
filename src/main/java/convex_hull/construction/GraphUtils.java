...
public class GraphUtils {
    ...
    площадь. Если площадь меньше 0, то был осуществлён поворот по часовой стрелке.
    Если площадь больше 0, то был осуществлён поворот против часовой стрелки. Если
